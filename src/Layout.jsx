...
const OWNER_EMAIL = 'jarivera43019@gmail.com';
            ...
            <div className="flex items-center justify-between">
              ...
              {!user ? (
                <div className="flex items-center gap-3">
                  <Button variant="outline" onClick={() => window.location.href = '/GetStarted'}>
                    Sign In
                  </Button>
                  <Button
                ...
                <nav className="flex items-center gap-6">
                  <Link to={createPageUrl('StudentDashboard')}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                      currentPageName === 'StudentDashboard' ? 'bg-purple-100 text-purple-700 font-semibold' : 'text-gray-600 hover:bg-gray-100'
                    }`}>
                  ...
                  <Link to={createPageUrl('ParentDashboard')}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                      currentPageName === 'ParentDashboard' ? 'bg-purple-100 text-purple-700 font-semibold' : 'text-gray-600 hover:bg-gray-100'
                    }`}>
                  ...
                  <Link to={createPageUrl('LearningPlanView')}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                      currentPageName === 'LearningPlanView' || currentPageName === 'GenerateLearningPlan' ? 'bg-purple-100 text-purple-700 font-semibold' : 'text-gray-600 hover:bg-gray-100'
                    }`}>
                  ...
                  <Link to={createPageUrl('GamificationDashboard')}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                      currentPageName === 'GamificationDashboard' ? 'bg-purple-100 text-purple-700 font-semibold' : 'text-gray-600 hover:bg-gray-100'
                    }`}>
                  ...
                  <Link to={createPageUrl('AITutor')}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                      currentPageName === 'AITutor' ? 'bg-purple-100 text-purple-700 font-semibold' : 'text-gray-600 hover:bg-gray-100'
                    }`}>
                    <Brain className="w-4 h-4" />
                  ...
                  <Link to={createPageUrl('ClubDirectory')}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                      ['ClubDirectory','ClubDetail','ClubManagement'].includes(currentPageName) ? 'bg-purple-100 text-purple-700 font-semibold' : 'text-gray-600 hover:bg-gray-100'
                    }`}>
                    <Users className="w-4 h-4" />
                  ...
                  {isAdmin && (
                    <>
                      <Link to={createPageUrl('AdminDashboard')}
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                          currentPageName === 'AdminDashboard' ? 'bg-purple-100 text-purple-700 font-semibold' : 'text-gray-600 hover:bg-gray-100'
                        }`}>
                      ...
                      <Link to={createPageUrl('TeacherDashboard')}
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                          currentPageName === 'TeacherDashboard' ? 'bg-purple-100 text-purple-700 font-semibold' : 'text-gray-600 hover:bg-gray-100'
                        }`}>
                        <GraduationCap className="w-4 h-4" />
                        <span className="hidden md:inline">Teacher</span>
                      </Link>
                      <Link to={createPageUrl('EnrollmentManagement')}
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                          currentPageName === 'EnrollmentManagement' ? 'bg-purple-100 text-purple-700 font-semibold' : 'text-gray-600 hover:bg-gray-100'
                        }`}>
                        <Users className="w-4 h-4" />
                  ...
                  {isOwner && (
                    <Link to={createPageUrl('OwnerControlPanel')}
                      className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                        currentPageName === 'OwnerControlPanel' ? 'bg-purple-100 text-purple-700 font-semibold' : 'text-gray-600 hover:bg-gray-100'
                      }`}>
                  ...
                  <Link to={createPageUrl('NotificationSettings')}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                      currentPageName === 'NotificationSettings' ? 'bg-purple-100 text-purple-700 font-semibold' : 'text-gray-600 hover:bg-gray-100'
                    }`}>
